...
Status: Active accounting is now implemented in the opt-in Regional Rivalry pilot. Legacy campaigns retain their original rules. Earlier N-02a/b/c notes describe the preceding foundation; see REGIONAL_RIVALRY_PILOT.md for current activation, N-03 rivalry changes, N-04 region foundation, tests and remaining acceptance work. September 4, 2026.
