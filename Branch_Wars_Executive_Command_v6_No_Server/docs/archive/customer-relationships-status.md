...
Historical mechanics batch. The follow-on [service workforce planner](service-workforce-status.md) makes staffing comparisons actionable without changing these rules. See [blueprint progress](../roadmap.md) for the current package-level position.
