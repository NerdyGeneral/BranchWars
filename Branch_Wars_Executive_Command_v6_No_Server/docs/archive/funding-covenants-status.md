...
Follow-up: deposit-products-status.md documents the next funding-product slice. New pilots now also use depositProductsVersion=1 and handshake capability 6; the remainder of this document records the preceding covenant build.
