...
Follow-up: newly created pilots now include the Market Economy foundation. See MARKET_ECONOMY_STATUS.md for current conserved local books, supporting competitors, regional reporting, evidence and balance limitations. The remainder below records the preceding version, retained by existing saves.
