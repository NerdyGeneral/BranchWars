...
Historical batch record. The current release adds opt-in service goodwill and uses save format 8.4 for new customer-needs campaigns. See [Customer relationships status](CUSTOMER_RELATIONSHIPS_STATUS.md); the 8.3 mechanics and evidence below describe the preserved earlier build.
