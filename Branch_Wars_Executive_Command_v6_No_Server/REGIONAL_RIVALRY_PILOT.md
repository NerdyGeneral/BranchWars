...
Update: new pilots now also use the partial Regional Operations package. See REGIONAL_OPERATIONS_STATUS.md for current additions and remaining work. The rules and evidence below describe the original pilot version, still retained by existing saves.
