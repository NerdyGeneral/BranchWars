...
The working tree already contained changes to BRANCH_WARS.html and tests/engine.test.js, plus BANKING_EMPIRE_ROADMAP.md, PLANNING_UPGRADE_STATUS.md, and an untracked tools directory. Those are preserved, not treated as a clean committed release. In particular, tools/build_reference.js was not modified.
