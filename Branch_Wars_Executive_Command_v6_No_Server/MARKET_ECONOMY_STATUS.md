...
Follow-up: see CREDIT_LIFECYCLE_STATUS.md for the subsequent N-06 loan-lifecycle slice. New pilots now also use creditLifecycleVersion=1 and handshake capability 4; the remainder of this document records the preceding market-economy batch.
