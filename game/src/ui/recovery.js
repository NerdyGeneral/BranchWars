...
function renderBankRecovery(v) {
  ...
  $('#bankRecoveryMount').insertAdjacentHTML('afterbegin', `<section id="bankRecovery" class="recovery-panel">
    ...
    <details><summary>What the comparison does—and does not—predict</summary><p class="micro">One-month estimate under the current economy. Includes known executive expense and planned spending without counting advertising or training twice. It projects today's economy and your current commitments only, so events, rival moves, opportunity awards and future project benefits are outside it. Guarantees and signed obligations still stand. Moving staff can lift this month's profit while costing future sales, and deposit share alone is not a measure of health.</p><p class="micro">Stage changes only your draft; review the affected departments and executive response before Mark Ready. Undo is available until you edit that staged draft or lock the turn. Not every failing bank has a viable recovery option.</p></details>
  </section>`);
