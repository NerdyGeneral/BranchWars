...
function advertisingDeskContent(v, productPreview) {
 ...
 const budget=E.planBudget(v.me,draft);p._workforceReserved=budget.total-(budget.training||0)-(budget.advertising||0)-(budget.relationshipOffers||0)-(budget.onboarding||0);
 ...
 const measured='<p class="notice bad" role="status"><b>Advertising is paused.</b> Measured intake is zero at every budget: $560,000 over fourteen months saturated awareness and acquired no deposits, leaving the bank smaller. Budgets stay locked at $0 until attribution is repaired.</p>';
 ...
 return '<h3>LOCAL CAMPAIGN DESK</h3><p class="small muted">One standing campaign per bank. Pause it whenever you need to protect cash; existing awareness fades rather than disappearing immediately.</p><div class="advertising-controls">'+controls+'</div>'+
  ...
  measured+'<p class="micro muted">The budget is recurring and shares the plan’s cash/capital limits. Quotes use today’s balances before executive events, competition and operating cash flows; costs may pause to protect reserves. Reach is modelled contacts, not guaranteed applications. Advertising cannot bypass market quotas, create deposits, or replace retention staffing.</p>'+actual+
