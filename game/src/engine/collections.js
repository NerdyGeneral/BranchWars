...
function validateCreditPerformanceSave(g) {
  ...
  if(g.creditPerformanceVersion!==1||g.customerOwnershipVersion!==1||g.version!==(g.relationshipOffersVersion===1?'8.12':g.regionalGrowthVersion===1?'8.11':g.advertisingVersion===1?'8.10':g.productProgramsVersion===1?'8.9':g.segmentDepositsVersion===1?'8.8':'8.7'))throw Error('Unsupported credit performance save');
