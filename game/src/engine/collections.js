...
function validateCreditPerformanceSave(g) {
  ...
  if(g.creditPerformanceVersion!==1||g.customerOwnershipVersion!==1||g.version!==(g.segmentDepositsVersion===1?'8.8':'8.7'))throw Error('Unsupported credit performance save');
