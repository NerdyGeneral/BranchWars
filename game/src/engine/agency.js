...
function initializeAgency(g) {
  if (![3,4,5,6].includes(g.financialGroupVersion)) return;
...
function validateAgencySave(g) {
  if (![3,4,5,6].includes(g.financialGroupVersion)) {
...
function validateAgencyView(view) {
  if (![3,4,5,6].includes(view.financialGroupVersion)) {
...
function planAgency(g, index, plan) {
  if (![3,4,5,6].includes(g.financialGroupVersion)) return plan;
