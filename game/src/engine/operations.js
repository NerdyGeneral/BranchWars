...
function operatingPreview(p,plan,economy){
 if(p.departmentOffice){
  ...
  const functionPrepared=prepareDepartmentFunctionForecast(p,normalized),prepared=prepareOperatingForecast(functionPrepared,normalized),facilityCost=facilityDraftSpend(prepared,normalized),
