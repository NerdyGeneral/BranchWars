...
function migrateCampaign(g){
 ...
 if(g.financialGroupVersion!==undefined||g.featureRulesVersion!==undefined||g.productProgramsVersion===2||['8.14','8.15','9.0','9.1'].includes(g.version))validateCampaignRules(g,'game');
 else {
