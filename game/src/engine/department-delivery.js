// Group6 pure runtime capacity adapter. No campaign mutation, payment, hiring,
...
const DepartmentDelivery=(()=>{
  ...
  function validate(dispatch,a,actual){
    if(!exact(actual,['headcount','physicalQuarters','paidVendorQuarters'])||!whole(actual.headcount,DepartmentFunctions.RULES.maxHeadcount)||
    ...
    if(!a||!whole(a.employedHeadcount,DepartmentFunctions.RULES.maxHeadcount)||!roleMap(a.assignedQuarters,true)||!roleMap(a.paidTeacherQuarters,true)||
