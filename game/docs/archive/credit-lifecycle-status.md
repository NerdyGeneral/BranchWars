...
Follow-up: funding-covenants-status.md records the next funding/recovery batch. New pilots now also include fundingCovenantVersion=1 and handshake capability 5. The details below document the preceding credit-lifecycle build.
