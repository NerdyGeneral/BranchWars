...
| N-04 Regional customers | Two regions, six markets, finite outside books, local demand mixes, product fit, persistent service goodwill; opt-in conserved household segment counts with service-related departures | Segment-owned deposit accounts and cross-selling, richer firm/household economy, adjacency and fuller entry economics |
...
| N-06 Products/cohorts | Simultaneous retail offers, deployments, account books, promotional/term funding, amortizing loan cohorts and funding covenants; differentiated household workload and retention mandate | Delayed delinquency/collections, richer product development and retirement, treasury stress tooling and segment-owned financial accounts |
...
2. N-04/N-06: the v8.6 slice now conserves household counts by segment and links retention time to acquisition capacity, goodwill and real outflows. Validate the tradeoff, then add delayed loan delinquency/collections and segment-owned deposit accounts. Pooled local-average withdrawals are explicitly an interim model; this is not completed cross-selling or household finance.
