...
| N-06 Products/cohorts | Simultaneous retail offers, deployments, account books, promotional/term funding, amortizing loan cohorts and funding covenants; household retention; opt-in delayed delinquency, non-accrual and capacity-constrained collections | Segment-owned financial accounts, fuller product development and retirement, treasury stress tooling, borrower/collateral detail and allowance accounting; human credit-policy acceptance |
