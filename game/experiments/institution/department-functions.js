// QUARANTINED N-05 candidate. Not a campaign rule, manifest entry or completed
// department system. Version/save/UI integration must be reviewed separately.
//
...
const DepartmentFunctions = (() => {
  ...
  const RULES=Object.freeze({maxHeadcount:100,maxQuarters:400,maxWorkload:1000000,maxVendorQuarters:16,maxCash:1000000000,historyLimit:24});
