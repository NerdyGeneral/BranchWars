...
const commands = args.includes('--full')
  ...
  : [['tools/build_reference.js', '--check'], ['tests/docs.test.js'], ['tests/architecture.test.js'],
     ['tests/behavior-golden.test.js'], ['tests/save-baseline.test.js'], ['tests/launcher-path.test.js'],
