...
if not defined LANIP goto noAddress
...
rem Read the URL after the FOR finishes; expansion inside an enclosing IF block
rem would use its earlier empty value. No CALL or delayed expansion of paths.
if not defined GAMEURL goto noUrl
start "" "%GAMEURL%"
exit /b 0
